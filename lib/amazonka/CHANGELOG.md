...
- `amazonka-appfabric`: Connect SaaS applications to work better together. [Overview](https://aws.amazon.com/appfabric/)
...
- `amazonka-cleanrooms`: AWS Clean Rooms helps customers and their partners more easily and securely collaborate and analyze their collective datasets—without sharing or copying one another’s underlying data. [Overview](https://aws.amazon.com/clean-rooms/)
- `amazonka-cloudtrail-data`: The CloudTrail Data Service lets you ingest events into CloudTrail from any source in your hybrid environments. [Overview](https://docs.aws.amazon.com/awscloudtraildata/latest/APIReference/Welcome.html)
...
- `amazonka-internetmonitor`: Provides visibility into how internet issues impact the performance and availability between your applications hosted on AWS and your end users. [Overview](https://docs.aws.amazon.com/internet-monitor/latest/api/Welcome.html)
...
- `amazonka-ivs-realtime`: A stage in Amazon IVS is a virtual space where multiple participants can exchange audio and video in real time. [Overview](https://docs.aws.amazon.com/ivs/latest/RealTimeAPIReference/Welcome.html)
...
- `amazonka-kendra-ranking`: Amazon Kendra Intelligent Ranking uses Amazon Kendra semantic search capabilities to intelligently re-rank a search service's results. [Overview](https://docs.aws.amazon.com/kendra/latest/APIReference/API_Operations_Amazon_Kendra_Intelligent_Ranking.html)
...
- `amazonka-mediapackagev2`: AWS Elemental MediaPackage (MediaPackage) is a just-in-time video packaging and origination service that runs in the AWS Cloud. [Overview](https://docs.aws.amazon.com/mediapackage/latest/userguide/what-is.html)
...
- `amazonka-osis`: Amazon OpenSearch Ingestion is a fully managed, serverless data collector that delivers real-time log, metric, and trace data to Amazon OpenSearch Service domains and OpenSearch Serverless collections. [Overview](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/ingestion.html)
- `amazonka-payment-cryptography`: Use the AWS Payment Cryptography Control Plane to manage the encryption keys you use for payment-related cryptographic operations. [Overview](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/Welcome.html)
- `amazonka-payment-cryptography-data`: Use the AWS Payment Cryptography Data Plane to manage how encryption keys are used for payment-related transaction processing and associated cryptographic operations. [Overview](https://docs.aws.amazon.com/payment-cryptography/latest/DataAPIReference/Welcome.html)
...
- `amazonka-tnb`: Automate the deployment and management of your telco networks on AWS. [Overview](https://aws.amazon.com/tnb/)
...
- `amazonka-verifiedpermissions`: Amazon Verified Permissions is a scalable permissions management and fine-grained authorization service for the applications that you build. [Overview](https://aws.amazon.com/verified-permissions/)
- `amazonka-vpc-lattice`: Simplify and automate service connectivity using Amazon VPC Lattice to discover and securely connect services across VPCs and accounts. [Overview](https://aws.amazon.com/vpc/lattice/)
